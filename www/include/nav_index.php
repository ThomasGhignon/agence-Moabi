<nav>
  <div class="wrap_nav">
    <div class="nav_logo">
      ...
      <a class="js-scrollTo" href="#link-header">moabi</a>
    </div>
    <div class="js-largeButton">
    ...
    <div class="js-smallButton">
      <svg class="ham hamRotate ham8 js-navHamburger" viewBox="0 0 100 100" width="50">
        <path
              class="line top"
